...
public interface List<E> {
     ...
     * 특정 위치 및 이후의 요소들은 한 칸씩 뒤로 이동합니다.
     *
     ...
     *
     * @param index 리스트에서 삭제할 특정 위치 변수
     * @return 삭제할 요소를 반환
     */
    E remove(int index);
     ...
     *
     * @param index 리스트에 접급할 특정 위치 변수
     * @return 리스트의 index 특정 위치의 요소 반환
     */
    E get(int index);
    ...
    /**
     * 리스트에 특정 요소가 있는지 여부를 확인합니다.
     *
     * @param value 리스트에서 찾을 특정 요소
     * @return 리스트에 특정 요소가 존재할 경우, {@code true}를 반환하고
     ...
     * @return 리스트에 요소가 없을 경우, {@code true} 를 반환하고
     *         요소가 있을 경우, {@code false} 를 반환
     */
    boolean isEmpty();
